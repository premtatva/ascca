    ...
    def basketball_scorecard():
        ...
        if quater in ["1", "2", "3"]:
            if team1_score > team2_score:
                st.subheader(team1_name + " leads by " + str(total1_score) + " Basket . Play The Next Quater")
            elif team1_score < team2_score:
                st.subheader(team2_name + " leads by " + str(total2_score) + " Basket . Play The Next Quater ")
            elif team1_score == team2_score and team1_score != 0 and team2_score != 0:
                st.subheader("The Scores Are Equal . Play The Next Quater")
                
        # Determine and display winning team or tie at the end of game
        if quater == "4" and team1_score:
            if team1_score > team2_score:
...
if sport_name == "Volleyball":
    ...
    def volleyball_scorecard():
        ...
        if sets=="5" and team1_score==15 or team2_score==15:
...
if sport_name == "Soccer":
    ...
    def soccer_scorecard():
        ...
        total2_score = team2_score - team1_score
        if team1_score>team2_score:
            st.subheader(team1_name + "leads by " + str(total1_score) + " Goals ")
        if team1_score<team2_score:
            st.subheader(team1_name + " leads by " + str(total2_score ) + " Goals ")
        if team1_score==team2_score:
            st.subheader("Scores Are Equal")
        # Display total scores
        st.write(team1_name + " Total Score: " + str(team1_score))
        st.write(team2_name + " Total Score: " + str(team2_score))
